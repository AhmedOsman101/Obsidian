...
class RememberCursorPosition extends obsidian.Plugin {
	...
	checkEphemeralStateChanged() {
		var _a;
		const fileName =
			(_a = this.app.workspace.getActiveFile()) === null || _a === void 0
				? void 0
				: _a.path;
				...
				if (fileName) {
					...
					if (st) {
						...
						for (let i = 0; i < 20; i++) {
							scroll =
								(_c =
									(_b = this.app.workspace.getActiveViewOfType(
										obsidian.MarkdownView,
									)) === null || _b === void 0
										? void 0
										: _b.currentMode) === null || _c === void 0
									? void 0
									: _c.getScroll();
	...
	readDb() {
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (yield this.app.vault.adapter.exists(this.settings.dbFileName)) {
				const data = yield this.app.vault.adapter.read(
	...
	writeDb(db) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			const newParentFolder = this.settings.dbFileName.substring(
				0,
			...
			(_c =
				(_b =
					(_a = this.app.workspace.getActiveViewOfType(
						...
						? void 0
						: _a.currentMode) === null || _b === void 0
					? void 0
					: _b.getScroll()) === null || _c === void 0
				? void 0
				: _c.toFixed(4),
		);
	...
	getEditor() {
		var _a;
		return (_a = this.app.workspace.getActiveViewOfType(
			obsidian.MarkdownView,
		)) === null || _a === void 0
			? void 0
			: _a.editor;
