...
prev:
  text: "Section 4"
  link: "/College/yearOne/firstTerm/IT-Essentials/Sections/Section-4"
next:
  text: "Section 6"
  link: "/College/yearOne/firstTerm/IT-Essentials/Sections/Section-6"
lastUpdated: false
---
...
- **[OSI Model](../Lectures/Lecture-6.md#osi-model)**: A theoretical framework for network communication.
- **[TCP/IP Model](../Lectures/Lecture-6.md#tcp-ip-model)**: Practical implementation for Internet protocols.
