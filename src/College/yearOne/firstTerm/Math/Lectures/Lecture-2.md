...
prev:
  text: "Lecture 1"
  link: "/College/yearOne/firstTerm/Math/Lectures/Lecture-1"
next:
  text: "Lecture 3"
  link: "/College/yearOne/firstTerm/Math/Lectures/Lecture-3"
---
...
2. **Cofactor Matrix**
   The cofactor matrix is obtained by calculating the determinant of the minor for each element of $A$ following the [Sign rule](Lecture-2.md#sign-rule-for-determinants).
...
- Find the adjoint.
  ...
  Applying the [Sign rule](Lecture-2.md#sign-rule-for-determinants):
