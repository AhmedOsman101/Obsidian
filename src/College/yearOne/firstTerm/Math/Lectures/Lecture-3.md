...
prev:
  text: "Lecture 2"
  link: "/College/yearOne/firstTerm/Math/Lectures/Lecture-2"
next:
  text: "Lecture 4"
  link: "/College/yearOne/firstTerm/Math/Lectures/Lecture-4"
---
...
Expanding along the third column (Remember to apply the [Sign rule](Lecture-2.md#sign-rule-for-determinants)):
