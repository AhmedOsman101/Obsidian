...
prev:
  text: "Lecture 2"
  link: "/College/yearOne/secondTerm/C-Essentials/Lectures/Lecture-2"
next:
  text: "Lecture 4"
  link: "/College/yearOne/secondTerm/C-Essentials/Lectures/Lecture-4"
---
...
```c
// Integer 9 is implicitly converted to float
float num = 9;
...
```c
// Integer division, drops decimal (2.5 -> 2)
int result = 5 / 2;
...
```c
int english = 50, maths = 60;
if (english >= 50 && maths >= 50) {
  printf("Result: Pass\n"); // Output: Pass
} else {
  printf("Result: Fail\n");
}
