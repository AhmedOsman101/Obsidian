...
- *Why this matters:* Connection alone is insufficient; devices must agree on *how* to communicate.

## Protocols: The Rules of Communication

- **Protocols** are the established rules that govern communications between devices.
- *How they work:* Just as humans require common language, grammar, and punctuation, network devices require standardized protocols to ensure messages are understandable.
...
| **Broadcast** | One-to-all | Single sender to *all* devices on the network |
...
- *Why layered?* Higher layers provide services to applications; lower layers are concerned with moving data and providing services to upper layers.
