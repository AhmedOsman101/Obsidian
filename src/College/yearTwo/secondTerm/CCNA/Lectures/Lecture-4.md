...
*How it works:* Each layer strips its own header, then passes the remaining data to the next higher layer.
...
| **Data Link Layer Address** | Layer 2 | Delivers **frame** from one NIC to another NIC on the *same network* |
