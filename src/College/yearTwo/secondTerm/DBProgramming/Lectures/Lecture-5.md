...
> [!IMPORTANT]
> *COUNT(*) counts all rows including NULLs, while COUNT(column) counts only non-NULL values in that column.*
...
> [!NOTE]
> *NULLIF(expr1, expr2) returns NULL only when expr1 = expr2; otherwise it returns expr1. Useful for preventing division by zero.*

> [!WARNING]
> *The order of CASE evaluation matters: first matching condition wins. Place specific conditions before general ones.*