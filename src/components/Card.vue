...
<template>
  ...
  >
    <div class="p-4 sm:p-6 pb-2 sm:pb-4">
      <h5
        class="mb-1 sm:mb-2 block font-sans text-base sm:text-lg font-semibold leading-snug tracking-normal text-gray-900 antialiased"
        v-text="title"
      />
      <p
        v-if="description?.length"
        class="block font-sans text-xs sm:text-sm font-light leading-relaxed text-inherit antialiased"
        v-text="description"
      />
    </div>
