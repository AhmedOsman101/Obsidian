...
<template>
  <section ref="head" class="px-5 p-4 sticky top-0 shadow-2xl z-50 text-white">
    <div class="flex gap-2 items-center w-full">
      <button
        class="w-8 h-8 grid place-items-center rounded-full hover:bg-[#181919]"
        @click="back">
        <i class="fa-solid fa-arrow-left"/>
      </button>
      <h1 class="text-xl font-bold" v-text="$props.title"/>
    </div>
  </section>
</template>
